USE EMP;
CREATE SCHEMA IF NOT EXISTS EMP.hrdata3;

-- Create Tables
CREATE TABLE IF NOT EXISTS hrdata3.employees
...
CREATE TABLE IF NOT EXISTS hrdata3.departments
   ( dept_id NUMBER(4)
...
INSERT INTO hrdata3.employees VALUES 
...
INSERT INTO hrdata3.departments VALUES 
